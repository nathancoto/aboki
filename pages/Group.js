                    ...
                    <View style={styles.headerButtons}>
                        ...
                        {this.state.displayHeaderInfo == true ?
                            <View style={styles.headerInfos}>
                                <Image source={{uri: this.state.group.photo_de_profil_du_groupe}} style={styles.headerImage} />
                                <Text style={styles.headerName}>{this.state.group.nom_du_groupe}</Text>
                            </View>
                            : <View style={{width: 45}} />
                        }
                        <TouchableOpacity
                ...
                <ScrollView style={styles.contentContainer} onScroll={this.handleScroll} scrollEventThrottle={16}>
                    ...
                    <View style={styles.photoName}>
                        <View style={styles.imageWrapper}>
                            <Image source={{uri: this.state.group.photo_de_profil_du_groupe}} style={styles.image} />
                        </View>
                        <Text style={styles.name}>{this.state.group.nom_du_groupe}</Text>
                        <Text style={styles.nbParticipants}>{this.state.group.nb_participants} Participants</Text>
                    </View>

                    <View style={styles.infos}>
                        <View style={styles.infosEl}>
                            <Location height={20} style={styles.infosIcon} />
                            <Text style={styles.infosText}>{this.state.group.lieu}</Text>
                        </View>
                        <View style={styles.infosEl}>
                    ...
                    <View style={styles.posts}>
                        <Text style={styles.postsTitle}>Dernier(s) post(s)</Text>
